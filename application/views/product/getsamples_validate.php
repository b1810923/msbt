...
#vali,#wagi,
#dazo,#donzu,#amra,#haju,#limya,#table{
    display:none;
}
#banner{
    position: relative;
...
<div id="misua" name="misua" class="samples">
  <div class="item"> 
    ...
    foreach ($item_array AS $eng => $chinese){
            ...
            $list_name = "<label for='".$id_name."'>".$chinese."</label>";
    ...
    ?>
    <td>
    <img alt="<?php echo $value_name;?>" onclick="imgcheckBox('<?php echo $id_name;?>')" title="<?php echo $value_name;?>" src="<?php echo base_url();?>img/getsample/<?php echo $item_key.'_'.$img_file;?>.jpg"><br/>
    <input type="checkbox" name="sample[]" id="<?php echo $id_name;?>" value="<?php echo $value_name;?>" onclick="checkBox(this)"> <span><?php echo $list_name;?></span>
    <td/>
    <?php
      if($k == 7){
        $k = 1;
...
<div id="pimu" name="pimu" class="samples">
  ...
  <div class="item"> 
    ...
    ?>
      <td>
        <img alt="<?php echo $value_name;?>" onclick="imgcheckBox('<?php echo $id_name;?>')" title="<?php echo $value_name;?>" src="<?php echo base_url();?>img/getsample/<?php echo $img_file;?>.jpg"><br/>
        <input type="checkbox" name="sample[]" id="<?php echo $id_name;?>" value="<?php echo $value_name;?>" onclick="checkBox(this)"> <span><?php echo $list_name;?></span>
      </td>
    <?php
...
<div id="wagi" name="wagi" class="samples">
 <div class="item"> 
    ...
    ?>
    <td>
      <img title="<?php echo $value_name;?>" onclick="imgcheckBox('<?php echo $id_name;?>')" alt="<?php echo $value_name;?>" src="<?php echo base_url();?>img/getsample/<?php echo $img_file;?>.jpg"><br/>
      <input type="checkbox" name="sample[]" id="<?php echo $id_name;?>" value="<?php echo $value_name;?>" onclick="checkBox(this)"> <span><?php echo $list_name;?></span>
...
<div id="haju" name="haju" class="samples">
  ...
  ?>
    ...
    foreach($array AS $eng => $chinese){
      $img_file = strtolower($eng);
            $img_file = str_replace(' ','_',$img_file);
            $id_name  = 's_'.$item_key.'_'.$eng;
            $value_name =   $item_key.' 裝飾布簾 '.$item_name.' '.'-'.' '.$chinese;
            $list_name = "<label for='".$id_name."'>".$chinese."</label>";
    ...
    ?>
    <td>
    <img alt="<?php echo $value_name;?>" onclick="imgcheckBox('<?php echo $id_name;?>')" title="<?php echo $value_name;?>" src="<?php echo base_url();?>img/getsample/<?php echo $item_key.'s_'.$img_file;?>.jpg"><br/>
    <input type="checkbox" name="sample[]" id="<?php echo $id_name;?>" value="<?php echo $value_name;?>" onclick="checkBox(this)"> <span><?php echo $list_name;?></span>
    <td/>
    <?php
      if($a == $item_number){
  ...
  ?>
    ...
    foreach($array AS $eng => $chinese){
      $img_file = strtolower($eng);
            ...
            $list_name = "<label for='".$id_name."'>".$chinese."</label>";
      //if($id_name =""){}
      //cho '[debug] id name='.$id_name.' list name='.$list_name.'<br/>';
      $a ++;$k ++;
      //echo '[debug] k ='.$k.'<br/>';
...
<div id="table">
  <form id="form1" name="form1" method="post" action="<?php echo site_url('sample/validate');?>" onSubmit="return noitem()">

 <table class="table-form">
   <tr>
   <th rowspan="1">寄送內容</th>
    <td class="getsamplesNo" rowspan="3" id="getcontent1">
   ...
   <input type="hidden" name="checksample" id="checksample" value="" />
   <input type="hidden" name="checkNumber" id="checkNumber" value="" />
  </table>
    <div class="btn_div"><input type="submit" name="button1" value="下一頁" class="buttons"/></div>
  <br/><br/><br/>
 </form>
 <br/><br/>
  </div> <!-- end samples -->
...
/* 點圖片選取商品 */
function imgcheckBox(img){
 var node = document.getElementById(img);

  // checkbox check numbers
  if(node.checked){
    node.checked = false;
    Chknum--;
  }else{
...
function allnodeChecked(){
  ...
  for(var i=0;i<selectNum;i++){
    if(checkboxes[i].checked==true){
        ...
        (j<10)?(j='0'+j):(j=j);
         ...
         boxValue3 = boxValue3+'<li>'+j+' '+checkboxes[i].value+'<li>';
  ...
  document.getElementById('checkNumber').value = Chknum;
  document.getElementById('checksample').value = boxValue3;

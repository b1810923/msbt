...
class Product extends CI_Controller{
	...
	function taoza(){
		...
		$this->load->view('header/main');
		$this->load->view('menu/main_menu');
		$this->load->view('product/product_level2taoza', $menu_array);
		//*/
	...
	function simaXL(){
		...
		$this->load->view('header/main');
		$this->load->view('menu/main_menu');
		$this->load->view('product/product_level2simaXL', $menu_array);
		//*/
	...
	function canli(){
		...
		$menu_array['level2'] = $this->product_model->get_level3join('canli');
		//*/
		$this->load->view('header/main');
		$this->load->view('menu/main_menu');
		$this->load->view('product/product_level2', $menu_array);
	...
	function phula(){
		...
		$menu_array['level2'] = $this->product_model->get_level3join('phula');
		//*/
		$this->load->view('header/main');
		$this->load->view('menu/main_menu');
		$this->load->view('product/product_level2', $menu_array);
	...
	function laina(){
		...
		$menu_array['level2'] = $this->product_model->get_level3join('laina');
		//*/
		$this->load->view('header/main');
		$this->load->view('menu/main_menu');
		$this->load->view('product/product_level2', $menu_array);
	...
	function haju(){
		...
		$this->load->view('header/main');
		$this->load->view('menu/main_menu');
		$this->load->view('product/product_level2haju', $menu_array);
		//*/
			
	}
	function limya(){

		$menu_array['level2'] = $this->product_model->get_level3join('limya');
		//*/
		$this->load->view('header/main');
		$this->load->view('menu/main_menu');
		$this->load->view('product/product_level2', $menu_array);
	...
	function pole(){
		...
		$this->load->view('header/main');
		$this->load->view('menu/main_menu');
		$this->load->view('product/product_level2accessory', $menu_array);
		//*/
	...
	function testuse(){
		...
		$this->load->view('header/main');
		$this->load->view('menu/main_menu');
		$this->load->view('product/product_level2testuse', $menu_array);
	}
